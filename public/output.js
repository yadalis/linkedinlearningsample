...
var author$project$Main$JobStep = F3(
	function (number, customerComplaint, correction) {
		return {correction: correction, customerComplaint: customerComplaint, number: number};
	});
															...
															return function (engineModel) {
																return function (engineSerial) {
																	return function (jobSteps) {
																		return {branchDepartmentNumber: branchDepartmentNumber, branchNumber: branchNumber, branchPhoneNumber: branchPhoneNumber, customerAddressLine1: customerAddressLine1, customerAddressLine2: customerAddressLine2, customerName: customerName, customerPhoneNumber: customerPhoneNumber, engineMake: engineMake, engineModel: engineModel, engineSerial: engineSerial, jobSteps: jobSteps, make: make, mileage: mileage, model: model, repairOrderNumber: repairOrderNumber, unitNumber: unitNumber, unitVehicleIdNumber: unitVehicleIdNumber, year: year};
																	};
																};
															};
														};
...
var author$project$Utils$edges = {bottom: 0, left: 0, right: 0, top: 0};
			...
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										'RO# ' + elm$core$String$fromInt(model.repairOrderNumber))
									])),
								A2(
								mdgriffith$elm_ui$Element$paragraph,
								_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(model.repairOrderNumber))
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(model.branchNumber))
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(model.branchDepartmentNumber))
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.branchPhoneNumber)
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.customerName)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.customerAddressLine1)
									])),
								A2(
								mdgriffith$elm_ui$Element$paragraph,
								_List_Nil,
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.customerAddressLine2)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.customerPhoneNumber)
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.unitNumber)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.unitVehicleIdNumber)
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(model.year))
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.make)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.model)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(model.mileage))
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.engineMake)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.engineModel)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.engineSerial)
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_Utils_update(
							author$project$Utils$edges,
							{bottom: 10, left: 5, right: 75, top: 8})),
						mdgriffith$elm_ui$Element$Font$alignLeft,
						mdgriffith$elm_ui$Element$spaceEvenly,
						mdgriffith$elm_ui$Element$Border$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 237, 45, 45)),
							...
							[
								...
								_List_fromArray(
									[
										...
										_Utils_update(
											author$project$Utils$edges,
											{bottom: 10, left: 5, right: 60, top: 8})),
										mdgriffith$elm_ui$Element$Font$alignLeft,
										mdgriffith$elm_ui$Element$spaceEvenly,
										mdgriffith$elm_ui$Element$Border$color(
										A3(mdgriffith$elm_ui$Element$rgb255, 237, 45, 45)),
