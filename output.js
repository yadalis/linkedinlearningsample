...
{
	if (region.a3.am === region.bm.am)
	{
		return 'on line ' + region.a3.am;
	}
	return 'on lines ' + region.a3.am + ' through ' + region.bm.am;
}
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				(title !== doc.d_) && (_VirtualDom_doc.title = title = doc.d_);
			});
		}
	);
});
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cY: 'hidden', cB: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cY: 'mozHidden', cB: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cY: 'msHidden', cB: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cY: 'webkitHidden', cB: 'webkitvisibilitychange' }
		: { cY: 'hidden', cB: 'visibilitychange' };
}
...
var author$project$Main$JobStep = F3(
	function (number, customerComplaint, correction) {
		return {cI: correction, cL: customerComplaint, de: number};
	});
var author$project$Main$RepairOrder = function (repairOrderNumber) {
	return function (branchNumber) {
		return function (branchDepartmentNumber) {
			return function (branchPhoneNumber) {
				return function (customerName) {
					return function (customerAddressLine1) {
						return function (customerAddressLine2) {
							return function (customerPhoneNumber) {
								return function (unitNumber) {
									return function (unitVehicleIdNumber) {
													...
													return function (mileage) {
														return function (engineMake) {
															return function (engineModel) {
																return function (engineSerial) {
																	return function (jobSteps) {
																		return {bb: branchDepartmentNumber, bc: branchNumber, bd: branchPhoneNumber, bh: customerAddressLine1, bi: customerAddressLine2, bj: customerName, bk: customerPhoneNumber, bn: engineMake, bo: engineModel, bp: engineSerial, c9: jobSteps, bB: make, bD: mileage, bE: model, a0: repairOrderNumber, b2: unitNumber, b3: unitVehicleIdNumber, b9: year};
																	};
																};
															};
														};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$RepairOrder(30189)(20)(370)('816-123-1234')('FedEx')('4860 College Blvd')('Overland Park KS 66221')('785-532-8264')('UN-12334')('1HGCM82633A004352')(2018)('Peterbilt')('PB 2809')(123123)('Paccar')('PC-X3443 56345cw3 45w34534 ')('45ASDF')(
			_List_fromArray(
				[
					A3(author$project$Main$JobStep, 1, 'OIL COOLER HOUSING GASKET AND AIR COMPRESSOR COOLANT LINES', ' OIL COOLER HOUSING GASKET AND AIR COMPRESSOR COOLANT LINES LEAKING.'),
					A3(author$project$Main$JobStep, 2, 'POWER STEERING PUMP AND STEERING GEAR BOX LEAKING.', 'POWER STEERING PUMP AND STEERING GEAR BOX LEAKING.'),
					A3(author$project$Main$JobStep, 3, 'PICK UP AND DELIVER', 'PICK UP AND DELIVER')
				])),
...
var author$project$Main$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(
			author$project$Main$RepairOrder(30189)(20)(370)('816-123-1234')('FedEx')('4860 College Blvd')('Overland Park KS 66221')('785-532-8264')('UN-12334')('1NXSDRFGSCD45ASDF')(2018)('Peterbilt')('PB 2809')(123123)('Paccar')('PC-X344356')('45ASDF')(_List_Nil),
			elm$core$Platform$Cmd$none);
	});
...
var mdgriffith$elm_ui$Internal$Style$classes = {ca: 'a', aP: 'atv', cd: 'ab', ce: 'cx', cf: 'cy', cg: 'acb', ch: 'accx', ci: 'accy', cj: 'acr', a9: 'al', ba: 'ar', ck: 'at', aQ: 'ah', aR: 'av', cm: 's', cq: 'bh', cr: 'b', ct: 'w7', cv: 'bd', cw: 'bdt', av: 'bn', cx: 'bs', aw: 'cpe', cC: 'cp', cD: 'cpx', cE: 'cpy', J: 'c', ay: 'ctr', az: 'cb', aA: 'ccx', K: 'ccy', al: 'cl', aB: 'cr', cG: 'ct', cJ: 'cptr', cK: 'ctxt', cV: 'fcs', cW: 'fs', cX: 'g', aV: 'hbh', aE: 'hc', aW: 'hf', bv: 'hfp', cZ: 'hv', c$: 'ic', c1: 'fr', c5: 'iml', c6: 'it', c8: 'i', ae: 'nb', bG: 'notxt', df: 'ol', dh: 'or', W: 'oq', dl: 'oh', bK: 'pg', bL: 'p', dm: 'ppe', ds: 'ui', B: 'r', du: 'sb', dv: 'sbx', dw: 'sby', dx: 'sbt', dA: 'e', dB: 'cap', dC: 'sev', dJ: 'sk', y: 't', dM: 'tc', dN: 'w8', dO: 'w2', dP: 'w9', dQ: 'tj', aM: 'tja', dR: 'tl', dS: 'w3', dT: 'w5', dU: 'w4', dV: 'tr', dW: 'w6', dX: 'w1', dY: 'tun', b1: 'ts', Y: 'clr', d1: 'u', a5: 'wc', b7: 'we', a6: 'wf', b8: 'wfp', a7: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.cm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.J);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.cm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cX);
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.cm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bK);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.cm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bL);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.cm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.B);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.cm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dA);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.D)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dD.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dD.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.B) + ('-' + (elm$core$String$fromInt(pos.cF) + ('-' + (elm$core$String$fromInt(pos.aj) + ('-' + elm$core$String$fromInt(pos.ad)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cZ, mdgriffith$elm_ui$Internal$Style$classes.Y)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cZ, mdgriffith$elm_ui$Internal$Style$classes.W)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cV, mdgriffith$elm_ui$Internal$Style$classes.W)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cm) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.B) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cm) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cm) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.B) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cm) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.ay) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ax: closing, k: _List_Nil, O: _List_Nil, G: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								k: A2(
									elm$core$List$cons,
									{ax: '\n}', k: _List_Nil, O: props, G: '@supports (' + (prop + (':' + (value + (') {' + parent.G))))},
									rendered.k)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.G + ('{' + (renderValues(rule.O) + (rule.ax + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.dB + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.y + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.dB + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.y)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {ad: height / size, a2: size, b5: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cA, adjustment.cp, adjustment.cM, adjustment.da]);
	var lineHeight = 1.5;
	...
	return {
		cA: A3(mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				elm$core$String$fromFloat(converted.ad)),
				_Utils_Tuple2(
				'vertical-align',
				elm$core$String$fromFloat(converted.b5) + 'em'),
				_Utils_Tuple2(
				'font-size',
				elm$core$String$fromFloat(converted.a2) + 'em')
			]));
};
				...
				switch (rule.$) {
					...
					case 9:
						...
						var msPosition = A2(
							...
							_List_fromArray(
								[
									...
									'-ms-grid-row-span: ' + (elm$core$String$fromInt(position.ad) + ';'),
									'-ms-grid-column: ' + (elm$core$String$fromInt(position.cF) + ';'),
									'-ms-grid-column-span: ' + (elm$core$String$fromInt(position.aj) + ';')
								]));
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.B) + (' / ' + (elm$core$String$fromInt(position.B + position.ad) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.cF) + (' / ' + (elm$core$String$fromInt(position.cF + position.aj) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.B) + ('-' + (elm$core$String$fromInt(position.cF) + ('-' + (elm$core$String$fromInt(position.aj) + ('-' + elm$core$String$fromInt(position.ad)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.cm + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dA))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cm, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.ay, mdgriffith$elm_ui$Internal$Style$classes.K, mdgriffith$elm_ui$Internal$Style$classes.cj])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cm, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.ay, mdgriffith$elm_ui$Internal$Style$classes.K, mdgriffith$elm_ui$Internal$Style$classes.ch])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cm, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.ay, mdgriffith$elm_ui$Internal$Style$classes.ci])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cm, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.ay, mdgriffith$elm_ui$Internal$Style$classes.cg])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cm, mdgriffith$elm_ui$Internal$Style$classes.y, mdgriffith$elm_ui$Internal$Style$classes.a5, mdgriffith$elm_ui$Internal$Style$classes.aE])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cm, mdgriffith$elm_ui$Internal$Style$classes.y, mdgriffith$elm_ui$Internal$Style$classes.a6, mdgriffith$elm_ui$Internal$Style$classes.aW])))
			]),
		_List_fromArray(
			[
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ae, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.ca]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ae, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.cr]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ae, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.dh]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ae, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.df]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ae, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.c1]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.ae, mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.cq]));
						}
					}())
				]),
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.a9);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ba);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ce);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ck);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cd);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cf);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.cm + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.B + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.bv + (' height-fill-' + elm$core$String$fromInt(portion)))),
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.cm + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.J + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
...
var author$project$Main$dataHeaderPragraph = mdgriffith$elm_ui$Element$paragraph(
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$size(18)
		]));
var author$project$Main$dataValuePragraph = mdgriffith$elm_ui$Element$paragraph(
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$size(16)
		]));
var author$project$Utils$edges = {w: 0, b: 0, c: 0, a: 0};
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.cG + (' ' + mdgriffith$elm_ui$Internal$Style$classes.al)),
				A2(
					elm$core$List$cons,
...
var mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.al + (' ' + mdgriffith$elm_ui$Internal$Style$classes.K)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
					A2(
...
var mdgriffith$elm_ui$Element$Font$alignLeft = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.dR);
var mdgriffith$elm_ui$Element$Font$alignRight = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.dV);
...
var author$project$Main$estimatePanel = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						A3(mdgriffith$elm_ui$Element$rgb255, 237, 45, 45))
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										'RO# ' + elm$core$String$fromInt(model.a0))
									])),
								A2(
								mdgriffith$elm_ui$Element$paragraph,
								_List_Nil,
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('DRAFT 2018-10-30 10:45 AM ')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Main$dataHeaderPragraph(
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Repair Order#')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(model.a0))
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Branch Number')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Department Number')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bd)
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Customer Information')
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						...
						A3(mdgriffith$elm_ui$Element$rgb255, 247, 247, 247))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bj)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bh)
									])),
								A2(
								mdgriffith$elm_ui$Element$paragraph,
								_List_Nil,
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bi)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bk)
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Unit Information')
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
						A2(mdgriffith$elm_ui$Element$paddingXY, 50, 15),
						mdgriffith$elm_ui$Element$Font$alignLeft,
						mdgriffith$elm_ui$Element$spaceEvenly,
						mdgriffith$elm_ui$Element$Border$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 237, 45, 45)),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.b2)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('VIN')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.b3)
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(model.b9))
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bB)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bE)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Mileage')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Engine Make')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bn)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Engine Model')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text(model.bo)
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Engine Serail')
									])),
								author$project$Main$dataValuePragraph(
								_List_fromArray(
									[
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Job Step #1')
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
						A2(mdgriffith$elm_ui$Element$paddingXY, 5, 15),
						mdgriffith$elm_ui$Element$Font$alignLeft,
						mdgriffith$elm_ui$Element$spaceEvenly,
						mdgriffith$elm_ui$Element$Border$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 237, 45, 45)),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Customer Complaint')
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Complaint: OIL COOLER HOUSING GASKET AND AIR COMPRESSOR COOLANT LINES')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Correction')
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Correction: OIL COOLER HOUSING GASKET AND AIR COMPRESSOR COOLANT LINES')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('CHARGE TYPE')
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('LABOR')
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$173.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$13.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('FRIEGHT')
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$243.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('SUBLET')
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$64.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('SHOP SUPPLIES')
									]))
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Job Step #2')
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Complaint: POWER STEERING PUMP AND STEERING GEAR BOX LEAKING.')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('Correction: POWER STEERING PUMP AND STEERING GEAR BOX LEAKING.')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$573.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$2543.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$1243.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$364.00')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$text('$74.00')
									]))
							]))
					])),
				A2(
							...
							[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$text('Labor Total')
													]))
											])),
										A2(
										mdgriffith$elm_ui$Element$column,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$text('Parts Total')
													]))
											])),
										A2(
										mdgriffith$elm_ui$Element$column,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$text('Frieght Total')
													]))
											])),
										A2(
										mdgriffith$elm_ui$Element$column,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$text('Sublet Total')
													]))
											])),
										A2(
										mdgriffith$elm_ui$Element$column,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$text('Shop Supplies Total')
													]))
											])),
										A2(
										mdgriffith$elm_ui$Element$column,
								...
								_List_fromArray(
									[
										...
										mdgriffith$elm_ui$Element$Background$color(
										A3(mdgriffith$elm_ui$Element$rgb255, 209, 209, 209))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$text('Estimate Total ')
													]))
											])),
										A2(
										mdgriffith$elm_ui$Element$column,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														mdgriffith$elm_ui$Element$text('$11874.00')
													]))
											]))
									]))
							]))
...
var author$project$Main$optionsPanel = function (_n0) {
	var channelAttrs = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 86, 182, 139))
				])),
			mdgriffith$elm_ui$Element$pointer
		]);
	var channelEl = function (_n1) {
		var name = _n1.dd;
		var index = _n1.c3;
		return A2(
	...
	var activeChannelAttrs = _List_fromArray(
		[
			mdgriffith$elm_ui$Element$Background$color(
			A3(mdgriffith$elm_ui$Element$rgb255, 117, 179, 201)),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Background$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 219, 219, 219)),
				mdgriffith$elm_ui$Element$Font$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 25, 25, 25))
			]),
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$text(' ')
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{cV: elm$core$Maybe$Nothing, cZ: elm$core$Maybe$Nothing, dc: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.ds, mdgriffith$elm_ui$Internal$Style$classes.cm, mdgriffith$elm_ui$Internal$Style$classes.dA]))),
...
var mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {aa: almostShade.aa, ab: almostShade.ab, by: false, bH: almostShade.bH, a2: almostShade.a2};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A3(mdgriffith$elm_ui$Element$rgb255, 244, 65, 65),
					0)
				]),
			_List_fromArray(
				[
					author$project$Main$optionsPanel(model),
					author$project$Main$estimatePanel(model)
				])));
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {br: fragment, bw: host, bM: path, bO: port_, bR: protocol, bS: query};
	});
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		c4: author$project$Main$init,
		dL: elm$core$Basics$always(elm$core$Platform$Sub$none),
